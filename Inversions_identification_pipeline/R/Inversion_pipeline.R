      ...
      if (!is.null(filtered_dt) && nrow(filtered_dt) > 0) {
        ...
        if (any(the_event == "inversion")) {
          if(is_ambiguous(ann_block)){
            ...
            is_ivory_in_inversion <- check_gene_in_block(block_data=ann_inv, gene_order="genes_order.txt", gene_name="HMEL000025-RB")
        ...
        if (any(the_event == "translocation")) {
          ...
          is_ivory_in_translocation <- check_gene_in_block(block_data=ann_trans, gene_order="genes_order.txt", gene_name="HMEL000025-RB")
        ...
        if (any(the_event == "inversion+translocation")) {
          if(is_ambiguous(ann_block)){
            ...
            is_ivory_in_inv_trans <- check_gene_in_block(block_data=ann_inv_trans, gene_order="genes_order.txt", gene_name="HMEL000025-RB")
